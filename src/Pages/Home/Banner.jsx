    ...
    return (
        <div className='bg-[#C1DFE9] cus-img py-10 md:py-0'>
            <div className='md:w-[90%] mx-auto flex gap-10 flex-col md:flex-row md:h-[600px] justify-between items-center'>
                <div className='w-[80%] md:w-[45%] text-center md:text-start' data-aos="fade-right"
                    data-aos-offset="300" >
                ...
                <div className='grow relative hidden md:block' data-aos="fade-up-left" data-aos-easing="linear"
