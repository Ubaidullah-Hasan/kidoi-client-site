...
const AddToy = () => {
    ...
    const handleChackOut = (event) => {
        ...
        console.log(pName, sName, category, email, rating, quantity, picture, description)
    ...
    return (
        <div className='w-[90%] mx-auto'>
            <form onSubmit={handleChackOut} className=" bg-base-200 px-[97px] py-[60px] rounded-md space-y-6 my-[90px]">
                ...
                <div className='flex justify-between gap-6'>
                    ...
                    <div className="form-control w-full">
                        <input type="text" placeholder="Your Name" name='sName' className="input focus:outline-none" />
                    </div>
                </div>
                {/* row 2 */}
                <div className='flex justify-between gap-6'>
                ...
                <div className="form-control mt-6">
                    <button className="btn bg-[#FF3811] hover:bg-[#cb2200] border-none" >Add Product</button>
                </div>
            </form>
        </div>
    );
