...
const Row = ({ toy }) => {
    const { picture, name, subCategory, sellerName, price, _id, email } = toy;
    ...
    return (
        <>
            <tr >
                ...
                <th>
                    <button className="btn bg-red-500 hover:bg-red-600 border-0 btn-xs rounded-full">Delete</button>
                </th>
                <th>
